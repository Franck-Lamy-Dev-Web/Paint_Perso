...
function changeColor(newColor) {
  color = newColor;
  updateButtonStyles(newColor); // Met à jour les styles des boutons de couleur
}

// Met à jour les styles des boutons de couleur
function updateButtonStyles(selectedColor) {
  // Réinitialise le style de tous les boutons de couleur
  document.getElementById("blackBtn").className = "button";
  document.getElementById("redBtn").className = "button";
  document.getElementById("blueBtn").className = "button";

  // Ajoute la classe correspondante au bouton de couleur sélectionné
  document.getElementById(selectedColor + "Btn").className += " selected";
}
